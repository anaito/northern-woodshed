...
var woodchipSymbology = {
  "h": { label: "Hardwood woodchip supplier", color: "#A87001" },
  "s": { label: "Softwood woodchip supplier", color: "#38A700" }
};
      ...
      Object.keys(woodchipSymbology).forEach(function (k) {
        ...
        var subLayer = L.geoJSON(data, {
          ...
          pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, { icon: houseIcon(entry.color, "#000000", 1, 20) });
          },
          onEachFeature: function (feature, layer) {
...
Promise.all([
  ...
  loadForestryOperatorsFile("data/forestryOperators2014.geojson", "Forestry operators present in 2014");
  loadForestryOperatorsFile("data/forestryOperators2025.geojson", "Forestry operators present in 2025");
...
legend.onAdd = function () {
  ...
  // Infrastructure (house icon) — forestry operators + woodchip suppliers
  div.innerHTML += '<hr style="margin:8px 0;">';
  div.innerHTML += '<div class="legend-title">Infrastructure</div>';

  // Forestry operators: house icon, orange fill
  ...
  // Woodchip suppliers: SAME house icon shape/outline/size; only fill color differs.
  var hcSw = houseIcon("#A87001", "#000000", 1, 14).options.html;
  var scSw = houseIcon("#38A700", "#000000", 1, 14).options.html;
