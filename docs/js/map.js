...
function labelWithColorSwatch(colorHex, text) {
    return '<span class="lc-swatch" style="background:' + colorHex + '"></span>' + text;
}
        ...
        .then(function (data) {
            Object.keys(ownershipSymbology).forEach(function (key) {
                ...
                groupedControl.addOverlay(
                    subLayer,
                    labelWithColorSwatch(entry.color, entry.label),
...
loadRipley().then(function () {
    ...
    groupedControl.addOverlay(layers[0], labelWithColorSwatch("#B3CDE3", '25 mi distance from Ripley Heating Plant'), 'Woodshed Extents');
    groupedControl.addOverlay(layers[1], labelWithColorSwatch("#8C96C6", '50 mi distance from Ripley Heating Plant'), 'Woodshed Extents');
    groupedControl.addOverlay(layers[2], labelWithColorSwatch("#8856A7", '75 mi distance from Ripley Heating Plant'), 'Woodshed Extents');
    groupedControl.addOverlay(layers[3], labelWithColorSwatch("#810F7C", '100 mi distance from Ripley Heating Plant'), 'Woodshed Extents');
...
// Legend removed: symbols now live in the layer control.
