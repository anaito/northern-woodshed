...
loadRipley().then(function () {
    ...
    return Promise.all([
        loadGeoJson('data/ws_25_geojson.geojson', style25, 'Woodshed extent - 25 mi distance from plant'),
        loadGeoJson('data/ws_50_geojson.geojson', style50, 'Woodshed extent - 50 mi distance from plant'),
        loadGeoJson('data/ws_75_geojson.geojson', style75, 'Woodshed extent - 75 mi distance from plant'),
        loadGeoJson('data/ws_100_geojson.geojson', style100, 'Woodshed extent - 100 mi distance from plant')
    ]);
    ...
    groupedControl.addOverlay(layers[0], labelWithColorSwatch("#B3CDE3", "25 mi distance from plant", 0.40), 'Woodshed Extents');
    groupedControl.addOverlay(layers[1], labelWithColorSwatch("#8C96C6", "50 mi distance from plant", 0.40), 'Woodshed Extents');
    groupedControl.addOverlay(layers[2], labelWithColorSwatch("#8856A7", "75 mi distance from plant", 0.40), 'Woodshed Extents');
    groupedControl.addOverlay(layers[3], labelWithColorSwatch("#810F7C", "100 mi distance from plant", 0.40), 'Woodshed Extents');
