...
// --------------------------------------------------
function normalizeOwnership(v) { return normalizeText(v); }
...
// --------------------------------------------------
function normalizeForestType(v) { return normalizeText(v); }
...
var woodchipSymbology = {
    "h": { label: "Hardwood woodchip supplier", color: "#38A700" }, // green
    "s": { label: "Softwood woodchip supplier", color: "#A87001" }  // brown
};
...
woodshedLoad
    .then(function () { return loadRipley(); })
    .then(function () {
        ...
        return loadForestryOperatorsFile("data/forestryOperators2014.geojson", "Forestry operators present in 2014")
            .then(function () { return loadForestryOperatorsFile("data/forestryOperators2025.geojson", "Forestry operators present in 2025"); })
            .then(function () { return loadWoodchipSuppliers(); });
    })
    .then(function () { return loadWildlifePoints(); })
    .then(function () { addWoodshedToControl(); })
    .then(function () { return loadCommercialForest(); })
    .then(function () { return loadDnrForestType(); })
    .catch(function (err) { alert(err.message); });
