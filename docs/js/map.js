...
// --------------------------------------------------
// Forestry operators — points (forestryOperatorsType = business), house icon
// File: data/forestryOperators.geojson
// Attribute: forestryOperatorsType (all "business")
// --------------------------------------------------
  ...
  return fetch("data/forestryOperators.geojson")
    ...
    .then(function (data) {
      var opsLayer = L.geoJSON(data, {
        filter: function (feature) {
          var t = feature.properties ? feature.properties.forestryOperatorsType : "";
...
legend.onAdd = function () {
  ...
  div.innerHTML +=
    '<div class="legend-item">' +
    '<span style="display:inline-block; width:18px; height:18px; margin-right:8px;">' + opsSw + '</span>' +
    'Forestry operators' +
    '</div>';
